...
__conda_setup="$('/Users/kd/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
if [ -f "/Users/kd/miniforge3/etc/profile.d/mamba.sh" ]; then
    . "/Users/kd/miniforge3/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
