# Generated by Powerlevel10k configuration wizard on 2020-07-01 at 07:22 MDT.
...
() {
  ...
  # Show duration of the last command if takes longer than thi many seconds.
  ...
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#494b53'
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#f0f0f0'
